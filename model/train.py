...
def main():
    parser = argparse.ArgumentParser("Script to train a models.")
    ...
    parser.add_argument('--save-dir', help='Directory where models is saved.', required=True, type=str)
    parser.add_argument('--dev', help='Development data.', required=True, type=str)
    parser.add_argument('--text-enc', help='Name of models (bert|distilbert|roberta|deberta|ernie|electra|conv-bert|t5)'
                                           'Default: bert.', type=str, default='bert')
    parser.add_argument('--qrels', help='Ground truth file in TREC format.', required=True, type=str)
    parser.add_argument('--save', help='Name of checkpoint to save. Default: models.bin', default='models.bin', type=str)
